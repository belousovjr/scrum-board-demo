...
export default function CreateBoardForm({
  ...
  return (
    ...
    >
      ...
      <p className="text-xl font-bold text-center">Create Scrum Board</p>
      {/* <div> */}
      {/* <p className="text-base text-general-80 text-center">
          A lightweight Scrum Board with offline PWA support and WebRTC sync
          fully frontend with no backend.
        </p> */}
      {/* </div> */}
      <Textfield
        size="lg"
